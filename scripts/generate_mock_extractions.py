...
_MATERIAL_KEYWORDS: list[tuple[list[str], str, float]] = [
    ...
    (["polyester", "recycled polyester",
      "functional fabric", "fleece",
      "sweatshirt fabric", "microfibre"],       "Polyester", 0.88),
    (["organic cotton", "cotton blend",
      "cotton jersey", "cotton weave",
      "cotton"],                                "Cotton",    0.91),
]
...
_SKIP_TYPES = {
    "Bra", "Underwear Tights", "Socks", "Pyjama jumpsuit/playsuit",
    "Underwear bottom", "Underwear body", "Underwear set", "Kids Underwear top",
    "Long John", "Nipple covers", "Pyjama set", "Pyjama bottom", "Pyjama top",
    "Night gown", "Robe", "Sleeping sack", "Swimwear", "Swimwear bottom",
    "Swimwear top", "Swimwear set", "Swimsuit", "Bikini top", "Bikini bottom",
    "Sarong", "Bag", "Wallet", "Sunglasses", "Costumes", "Fine cosmetics",
    "Giftbox", "Garment Set", "Hair clip", "Hair string", "Hair/alice band",
    "Hair ties", "Other accessories", "Earring", "Necklace", "Bracelet",
    "Ring", "Gloves", "Unknown",
}
